...
router.get('/', authenticate, authorize('Vendedor', 'Administrador'), afiliadoController.getAll.bind(afiliadoController));

// GET afiliado por ID – clientes só podem acessar se for o próprio, vendedores todos
router.get('/:id', authenticate, authorize('Cliente', 'Vendedor', 'Administrador'), afiliadoController.getById.bind(afiliadoController));
...
router.patch('/:id/status', authenticate, authorize('Vendedor', 'Administrador'), afiliadoController.updateStatus.bind(afiliadoController));

// DELETE remover afiliado – apenas vendedores podem remover
router.delete('/:id', authenticate, authorize('Vendedor', 'Administrador'), afiliadoController.delete.bind(afiliadoController));
